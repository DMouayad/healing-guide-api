...
this.zxcvbnts.core = (function (exports) {
  ...
  class MatchSpatial {
    constructor() {
      this.SHIFTED_RX = /[~!src/#$%^&*()_+QWERTYUIOP{}|ASDFGHJKL:"ZXCVBNM<>?]/;
    }
              ...
              if (adjacent) {
                ...
                if (adjacentIndex !== -1) {
                  ...
                  if (adjacentIndex === 1) {
                    ...
                    // # for example, 'q' is adjacent to the entry '2src/'.
                    // # src/ is shifted w/ index 1, 2 is unshifted.
                    shiftedCount += 1;
  ...
  class Matching {
    constructor() {
      this.matchers = {
        ...
        regex: MatchRegex,
        // src/ts-ignore => TODO resolve this type issue. This is because it is possible to be async
        repeat: MatchRepeat,
  ...
  /**
   * src/link https://davidwalsh.name/javascript-debounce-function
   */
